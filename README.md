[![Ansible-Test](https://github.com/mediafellows/ansible-role-nginx/actions/workflows/ansible_test.yml/badge.svg)](https://github.com/mediafellows/ansible-role-nginx/actions/workflows/ansible_test.yml)
  ...
  roles:
    - role: nginx
      ...
      nginx_configs:
        ...
        upstream_group:
            # More handy for multiple server processes that run the same type of server on different ports or socks
            # Results in
